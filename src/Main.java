...
public class Main {
    ...
    private static void initRoutes(HttpServer server) {
        ...
        server.createContext("/apps/", App::handleAppsRequest);
        server.createContext("/apps/profile", Profile::handleProfileRequest);
    }
    ...
    private static void writeHeaders(PrintWriter writer, Headers headers) {
        write(writer, "Headers of the request", "");
